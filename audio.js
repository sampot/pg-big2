...
export class Big2Audio {
  ...
  play(n = 1) {
    this.tone(280, 0.05, "triangle", 0.09);
    this.tone(420 + n * 30, 0.08, "square", 0.07, 0.04);
  }

  pass() {
    this.tone(180, 0.07, "sawtooth", 0.05);
    this.tone(140, 0.1, "triangle", 0.04, 0.05);
  }
